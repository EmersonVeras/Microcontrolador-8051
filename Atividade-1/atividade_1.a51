org   0000h      ;Origem no endereço 00h de memória 
 ...
 REP:       
    ...
    DJNZ R1,REP    ;Decrementa o valor R1, se não for igual a zero salta para a subrotina REP
    RET      ;Retorno
 ...
 LOOP:   DJNZ R2,LOOP   ;Decrementa o valor R2, se não for igual a zero salta para a subrotina LOOP 
    DJNZ R3,TEMPO2   ;Decrementa o valor R0, se não for igual a zero salta para a subrotina TEMPO2
    RET       ;retorna
